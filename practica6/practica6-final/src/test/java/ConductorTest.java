...
public class ConductorTest {
	...
	public void testConstructor() {
		...
		assertEquals("Pepe Martinez Fernandez", sut.toString());

		sut= new Conductor("123123123X", "Pepe", "Martinez", null, "Avda. de los Castros s/n" );
		assertEquals("123123123X", sut.dni());
		assertEquals("Pepe Martinez", sut.toString());
	...
	public void testSueldoYAnhadeTransporte() {
		...
		Transporte transMercancias10horas100ton = new Transporte(10, CategoriaTransporte.Mercancias_Peligrosas, 100);
