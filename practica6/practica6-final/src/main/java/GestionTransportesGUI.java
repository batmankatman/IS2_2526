...
public class GestionTransportesGUI {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			// WMC/CCOg: el bucle del menu y el switch principal concentran la complejidad de esta clase.
			switch (opcion) {
			...
			case ANHADE_TRANSPORTE:
				...
				if (c!=null) {
					switch (tipo) {
						case "P":
							c.anhadeTransporte(new Transporte(horas, CategoriaTransporte.Personas, personas));
							break;
						case "M":
							c.anhadeTransporte(new Transporte(horas, CategoriaTransporte.Mercancias, toneladas));
							break;
						case "MP":
							c.anhadeTransporte(new Transporte(horas, CategoriaTransporte.Mercancias_Peligrosas, toneladas));
							break;		
					}
				} else {
